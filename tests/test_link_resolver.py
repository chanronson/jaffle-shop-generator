...
class TestLinkResolver:
    ...
    def test_resolve_link_entity_not_found(self):
        ...
        assert "Entity 'nonexistent' not found in schema 'test_schema'" in str(
            exc_info.value
        )
        ...
        schema = SystemSchema(
            ...
            entities={
                "orders": EntityConfig(
                    ...
                    attributes={
                        "user_id": AttributeConfig(
                            type="link", link_to="nonexistent.users.id"
                        )
                    },
                )
            },
        ...
        schema = SystemSchema(
            ...
            entities={
                "orders": EntityConfig(
                    ...
                    attributes={
                        "user_id": AttributeConfig(
                            type="link", link_to="invalid.format"
                        )
                    },
                )
            },
        ...
        schema = SystemSchema(
            ...
            entities={
                "orders": EntityConfig(
                    ...
                    attributes={
                        "user_id": AttributeConfig(
                            type="link", link_to="app.nonexistent.id"
                        )
                    },
                )
            },
        ...
        schema = SystemSchema(
            ...
            entities={
                ...
                "orders": EntityConfig(
                    ...
                    attributes={
                        "user_id": AttributeConfig(
                            type="link", link_to="app.users.nonexistent"
                        )
                    },
                ),
            },
                ...
                "entity_a": EntityConfig(
                    ...
                    attributes={
                        ...
                        "b_ref": AttributeConfig(
                            type="link", link_to="app.entity_b.id"
                        ),
                    },
                ),
                "entity_b": EntityConfig(
                    ...
                    attributes={
                        ...
                        "a_ref": AttributeConfig(
                            type="link", link_to="app.entity_a.id"
                        ),
                    },
                ),
            },
        ...
        schema = SystemSchema(
            ...
            entities={
                ...
                "entity_b": EntityConfig(
                    ...
                    attributes={
                        "id": AttributeConfig(type="uuid", unique=True),
                        "c_ref": AttributeConfig(
                            type="link", link_to="app.entity_c.id"
                        ),
                    },
                ),
